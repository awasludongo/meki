...
$banner = 'https://i.postimg.cc/WzjrQnNF/bqcuxpl.jpg';
    $favicon = 'https://i.ibb.co/Ng5snwpV/icon.png';
    $logo = 'https://i.ibb.co/v48YhC0K/da4b6e4af4772d67ace070e1fba3f10e.jpg';
    $brandUp = strtoupper($brand);

    $contents = file_get_contents(__DIR__ . '/thaikeyword.txt');
    $keywords = explode("\r\n", $contents);

$title = "{$brand} - แหล่งรวมสล็อต PG แท้ เล่นง่าย จ่ายจริง 2024";
$description = "{$brand} เป็นแหล่งรวมเกมสล็อต PG แท้ที่เล่นง่ายและจ่ายจริง มีเกมสล็อตให้เลือกเล่นมากมายจากค่าย PG SLOT ที่ขึ้นชื่อเรื่องโบนัสแตกง่าย แจ็คพอตออกบ่อย รองรับการเล่นผ่านมือถือทุกระบบ ทำให้คุณสามารถเล่นได้ทุกที่ทุกเวลา ระบบฝาก-ถอนอัตโนมัติที่รวดเร็วและปลอดภัย ทำให้การเล่นสล็อตของคุณสะดวกและราบรื่น พร้อมโปรโมชั่นสุดคุ้มสำหรับสมาชิกใหม่และเก่า หากคุณกำลังมองหาเว็บไซต์สล็อต PG ที่มั่นคงและเชื่อถือได้ ไม่ควรพลาด {$brand}!";
$article = "{$brand} เป็นเว็บไซต์ที่รวบรวมเกมสล็อต PG แท้ที่เล่นง่ายและจ่ายเงินจริง มีเกมให้เลือกเล่นมากมายจากค่าย PG SLOT ซึ่งเป็นค่ายเกมยอดนิยมที่มีเกมสล็อตคุณภาพสูง แจ็คพอตแตกง่าย และโบนัสออกบ่อย คุณสามารถเล่นผ่านมือถือได้ทุกที่ทุกเวลา ไม่ว่าจะเป็นระบบ iOS หรือ Android ระบบฝาก-ถอนอัตโนมัติที่รวดเร็วช่วยให้คุณทำธุรกรรมได้อย่างสะดวกปลอดภัยภายในไม่กี่วินาที อีกทั้งยังมีโปรโมชั่นสุดพิเศษที่ช่วยเพิ่มโอกาสทำกำไรให้กับคุณ ไม่ว่าคุณจะเป็นมือใหม่หรือผู้เล่นเก่า ก็สามารถสนุกไปกับเกมสล็อต PG ได้อย่างไม่มีขีดจำกัด สมัครเลยที่ {$brand} แล้วสัมผัสประสบการณ์เล่นสล็อต PG แท้ที่ดีที่สุด!";
...
<head>
  ...
  <style>
    ...
    .lzd-header-banner {
      background-image: url(https://i.ibb.co/Ng5snwpV/icon.png) !important;
